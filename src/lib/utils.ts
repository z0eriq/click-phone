...
export const SHIPPING_COST = parseFloat(process.env.SHIPPING_COST || "5000");
export const FREE_SHIPPING_THRESHOLD = parseFloat(process.env.FREE_SHIPPING_THRESHOLD || "100000");
